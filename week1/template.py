...
class MLP(nn.Module):
    def __init__(self):
        ...
        self.fc2 = nn.Linear(____, ____)    #建议为2的幂次
        self.fc3 = nn.Linear(____, 10)     # 10分类（数字0-9）
...
optimizer = optim.Adam(model.parameters(), lr= ______ )  # Adam自适应学习率优化
