...
# ========== 思考问题 ==========
"""
Q1: 输入是 5x5,卷积核 3x3,stride=1,padding=0,输出为什么是 3x3?
    提示：想想滑动窗口能从左上角走到右下角需要几步？
    答：横向能放 (5-3)/1 + 1 = 3 个位置，纵向同理 → 3x3

Q2: 如果 padding=1(边缘补一圈0)，输出会变成多大?
    答：(5 + 2*1 - 3)/1 + 1 = 5 → 输出 5x5
"""
